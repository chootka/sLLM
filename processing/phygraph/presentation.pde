void drawPresentation(float[] SamplingData, float[] XOut, float twoSampleView, float elapsedTime, String samples, String durationVal, String samplesPerSecond, float sliderValue, int counterSamples, float hertz, int N, String[] folderName, String captureImgName, float orderOfMagnitude, int viewHertzSize, float[] hertzArray) {
 ...
 //textSize(13);
  ...
  if(folderName != null && folderName.length > 2) {
